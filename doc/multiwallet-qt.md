...
In order to support loading of multiple wallets in BeaconCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BeaconCoin.cpp.
...
Changes to BeaconCoin.cpp
----------------------
BeaconCoin.cpp is the entry point into BeaconCoin-qt, and as such, will require some minor modifications to provide hooks for
