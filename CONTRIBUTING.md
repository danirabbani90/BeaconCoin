Contributing to BeaconCoin Core
==================================

The BeaconCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BeaconCoin Core project, and is not to be
confused with overall BeaconCoin Network Protocol consensus changes.

Whether a pull request is merged into BeaconCoin Core rests with the project merge
...
Patches that change BeaconCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BeaconCoin consensus, it must have been
...
The project leader is the release manager for each BeaconCoin Core release.
