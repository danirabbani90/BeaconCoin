...
#   c) node1 mines 32 blocks, so now node 0 has 500000BCC, node 1 has 4250BCC, node2 has none.
#   d) node0 sends 601 BCC to node2, in two transactions (301 BCC, then 300 BCC).
