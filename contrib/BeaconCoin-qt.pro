...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/BeaconCoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/BeaconCoin-cli.cpp \
           src/BeaconCoin-tx.cpp \
           src/BeaconCoin.cpp \
           src/db.cpp \
           ...
           src/qt/BeaconCoin.cpp \
           src/qt/BeaconCoinstrings.cpp \
...
RESOURCES += src/qt/BeaconCoin.qrc src/qt/BeaconCoin_locale.qrc

TRANSLATIONS += src/qt/locale/BeaconCoin_bg.ts \
                src/qt/locale/BeaconCoin_de.ts \
                src/qt/locale/BeaconCoin_en.ts \
                src/qt/locale/BeaconCoin_es.ts \
                src/qt/locale/BeaconCoin_fi.ts \
                src/qt/locale/BeaconCoin_fr.ts \
                src/qt/locale/BeaconCoin_it.ts \
                src/qt/locale/BeaconCoin_ja.ts \
                src/qt/locale/BeaconCoin_pl.ts \
                src/qt/locale/BeaconCoin_pt.ts \
                src/qt/locale/BeaconCoin_ru.ts \
                src/qt/locale/BeaconCoin_sk.ts \
                src/qt/locale/BeaconCoin_sv.ts \
                src/qt/locale/BeaconCoin_vi.ts \
                src/qt/locale/BeaconCoin_zh_CN.ts \
                src/qt/locale/BeaconCoin_zh_TW.ts
