...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 100010000000.0)
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BeaconCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BeaconCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BeaconCoin features */
        {"BeaconCoin", "masternode", &masternode, true, true, false},
        {"BeaconCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"BeaconCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BeaconCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BeaconCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BeaconCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"BeaconCoin", "startmasternode", &startmasternode, true, true, false},
        {"BeaconCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BeaconCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BeaconCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BeaconCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BeaconCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BeaconCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BeaconCoin", "mnbudget", &mnbudget, true, true, false},
        {"BeaconCoin", "preparebudget", &preparebudget, true, true, false},
        {"BeaconCoin", "submitbudget", &submitbudget, true, true, false},
        {"BeaconCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BeaconCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BeaconCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BeaconCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BeaconCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BeaconCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BeaconCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BeaconCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"BeaconCoin", "mnsync", &mnsync, true, true, false},
        {"BeaconCoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
static void RPCAcceptHandler(boost::shared_ptr<basic_socket_acceptor<Protocol> > acceptor,
    ...
    const boost::system::error_code& error)
{
    // Immediately start accepting new connections, except when we're canbcced or our socket is closed.
...
void StopRPCThreads()
{
    ...
    BOOST_FOREACH (const boost::shared_ptr<ip::tcp::acceptor>& acceptor, rpc_acceptors) {
        acceptor->cancel(ec);
        if (ec)
            LogPrintf("%s: Warning: %s when canbccing acceptor", __func__, ec.message());
    }
    rpc_acceptors.clear();
    BOOST_FOREACH (const PAIRTYPE(std::string, boost::shared_ptr<deadline_timer>) & timer, deadlineTimers) {
        timer.second->cancel(ec);
        if (ec)
            LogPrintf("%s: Warning: %s when canbccing timer", __func__, ec.message());
    }
...
{
    return "> BeaconCoin-cli " + methodname + " " + args + "\n";
}
