...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BeaconCoin Core"),
     ...
     * override -datadir in the BeaconCoin.conf file in the default data directory
     * (to be consistent with BeaconCoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
