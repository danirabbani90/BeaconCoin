                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BeaconCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BCC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BeaconCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BeaconCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BeaconCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BeaconCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BCC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BCC addresses"));
    ...
    openAction->setStatusTip(tr("Open a BeaconCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BeaconCoin Core help message to get a list with possible BeaconCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BeaconCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BeaconCoin network", "", count));
}
...
{
    QString strTitle = tr("BeaconCoin Core"); // default title
