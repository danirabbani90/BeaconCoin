...
/** Utility functions used by the BeaconCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BCC addresses in monospace font
...
// Parse "BeaconCoin:" URI into recipient object, return true on successful parsing
