...
#if defined(NDEBUG)
#error "BeaconCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubcc) are considered zero fee (for relaying and mining)
...
{
    RenameThread("BeaconCoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // BCC: We use certain sporks during IBD, so check to see if they are
